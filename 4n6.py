...
A = Tkinter.Button(top, text ="NSM ARENA #1", command = arena1)
A.grid(row=1, column=0, sticky=W+E, columnspan=4)
B = Tkinter.Button(top, text ="NSM ARENA #2", command = arena2)
B.grid(row=2, column=0, sticky=W+E, columnspan=4)
C = Tkinter.Button(top, text ="NSM ARENA #3", command = arena3)
C.grid(row=3, column=0, sticky=W+E, columnspan=4)
D = Tkinter.Button(top, text ="NSM ARENA #4", command = arena4)
D.grid(row=4, column=0, sticky=W+E, columnspan=4)
arena5 = Tkinter.Button(top, text ="NSM ARENA #5", command = arena5)
